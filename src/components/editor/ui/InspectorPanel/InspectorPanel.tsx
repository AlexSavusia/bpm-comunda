                                ...
                                addableProps.length > 0 ? (
                                    <select
                                        ...
                                        onChange={(e) => {
                                            ...
                                            // включаем property (создаём ключ в templateProps)
                                            onSetNodeTemplateProp(selectedNode.id, k, "");

                                            // сброс селекта обратно на placeholder
                ...
                {p.key}
                                                    ...
                                                    {!isReq ? (
                                                        <button
                                                            ...
                                                            title="Remove"
                                                            onClick={() => {
                                                                // "удалить" = поставить undefined (мы ниже поправим setter)
